...
public class Backrooms {
    public static final String MODID = "assets/backrooms";
    public static final String NAME = "Backrooms Mod";
    public static final String VERSION = "1.0.0";

    public static SimpleNetworkWrapper packetHandler;

    @SidedProxy(clientSide = "com.integral.backrooms.proxy.ClientProxy", serverSide = "com.integral.backrooms.proxy.CommonProxy")
